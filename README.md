...
2. Split the dataset into features (X) and target variable (y) and divide it into training and testing sets.

3. Apply StandardScaler for feature scaling and train the SGDClassifier model using the training data.

4. Predict the output for test data and evaluate the model using accuracy score and confusion matrix.
